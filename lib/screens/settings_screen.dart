    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // Keep your existing settings tiles here (theme, etc.)
          ...
          Card(
            ...
            child: ListTile(
              leading: Icon(Icons.delete_forever, color: color.onTertiaryContainer),
              title: Text(
                "Reset all expenses",
              ...
              subtitle: Text(
                ...
                style: TextStyle(color: color.onTertiaryContainer.withOpacity(0.9)),
              ),
              trailing: Icon(Icons.chevron_right, color: color.onTertiaryContainer),
